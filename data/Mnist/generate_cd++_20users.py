...
label_list = list(set(mnist.target))

SHUFFLE_PERCENTAGE = 0.1

## Sample subset of labels and shuffle to replicate concept drift
...
#print("\nNumb samples of each label:\n", [len(v) for v in mnist_data])
users_lables = []
print("mnist_data",mnist_data[:10])
...
for i in range(NUM_USERS):
    ...
    ## Concept drift: Same feature, different label
    ## Change label with percentage
    for idx, l in enumerate(y[i]):
